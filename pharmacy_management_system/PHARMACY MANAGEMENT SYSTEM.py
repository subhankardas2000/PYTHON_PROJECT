...
button1.grid(row=1,column=4, padx=40, pady=10)#add button
button2.grid(row=2,column=4, padx=40, pady=10)#delete button
button7.grid(row=3,column=4, padx=40, pady=10)#update
button8.grid(row=4,column=4, padx=40, pady=10)#search
button9.grid(row=5,column=4, padx=40, pady=10)#clear

button3.grid(row=1,column=5, padx=40, pady=10)#first
button4.grid(row=2,column=5, padx=40, pady=10)#next
button5.grid(row=3,column=5, padx=40, pady=10)#previous
button6.grid(row=4,column=5, padx=40, pady=10)#last
